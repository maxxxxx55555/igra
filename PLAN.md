...
- [x] Перевести i18n-backlog (частично): `SCR_*` (122 ключа × 11 языков)
      done, commit `d329308`. Backlog 3424 → 2191 строк. Осталось:
      `Q_*`/`QUEST_*` (40), `SKILL_*` (28, минус новые 2), `ACH_*` (22),
      `END_*`/`ENDING_*` (25) и мельче — следующая волна.
