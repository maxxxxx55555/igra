...
@export var roster: Dictionary = {
	&"tramp": {
		"name": "Бродяга", "hp": 120, "damage": 12, "armor": 5,
	...
	&"cleaver": {
		"name": "Секач", "hp": 180, "damage": 18, "armor": 8,
		"weak_spot": "head", "behaviors": [Behavior.CHASE],
		"inflicts": [Status.BLEED],
	...
	&"runner": {
		"name": "Бегун", "hp": 80, "damage": 8, "armor": 2,
	...
	&"rotter": {
		"name": "Гнилец", "hp": 350, "damage": 15, "armor": 20,
	...
	&"spitter": {
		"name": "Плююн", "hp": 140, "damage": 10, "armor": 5,
	...
	&"beast": {
		"name": "Тварь", "hp": 1200, "damage": 30, "armor": 25,
		"weak_spot": "head", "behaviors": [Behavior.CHASE],
	...
	&"sniper": {
		"name": "Снайпер", "hp": 160, "damage": 25, "armor": 10,
		"weak_spot": "head", "behaviors": [Behavior.COVER],
		"inflicts": [Status.BLEED],
	...
	&"armored": {
		"name": "Броненосец", "hp": 400, "damage": 20, "armor": 35,
	...
	&"pyro": {
		"name": "Поджигатель", "hp": 200, "damage": 15, "armor": 5,
		"weak_spot": "head", "behaviors": [Behavior.CHASE],
	...
	&"larva": {
		"name": "Детёныш", "hp": 60, "damage": 6, "armor": 2,
	...
	&"dog": {
		"name": "Пёс", "hp": 70, "damage": 9, "armor": 3,
