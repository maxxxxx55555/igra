...
## ?????????? ??????: ??????? ???? ? ???????? ?????????? ?? ??????? ????????.
## ?????????: MENU -> AMBIENT -> TENSION -> BATTLE -> BOSS -> VICTORY.
## ??? ?????? ? ???????????? ??????????, ????? ????? ????? ?? ???????.
## Author: OpenCode
## Version: 2.0.0
...
const FADE_TIME: float = 2.2          ## ???????????? ????????????? ?????????, ?
const FULL_DB: float = -8.0           ## ??????? ????????? ??????
const MUTE_DB: float = -60.0
const EVAL_INTERVAL: float = 0.5      ## ??? ????? ????????????? ??????????, ?
const TENSION_RANGE: float = 22.0     ## ????????? ????????? ?????????? ?????, ?
const BATTLE_RANGE: float = 9.0       ## ????????? ???????? ? ?????? ????, ?
const CALM_DELAY: float = 6.0         ## ???????? ???????? ? ????????? ??????, ?
#endregion
