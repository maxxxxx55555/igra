...
[C] WORLD_DIARY_K3_TEXT | ar | Decided. The drinker finds the grid through the lamps that can burn; a dismantled lamp is a door walled shut. Order 14,208: dismantle 219, suburbs, transformer to the center. I kept the light for forty years. Now I keep it backwards. Forgive me, streets. | قررت. الذي يشرب يجد الشبكة عبر المصابيح القادرة على الاحتراق؛ المصباح المفكك باب مغلق بالجدار. الأمر 14208: فك 219، الضاحية، المحوّل إلى المركز. حفظت الضوء لأربعين عامًا. الآن أحفظه بالعكس. سامحيني أيتها الشوارع.
[H] enc_locked | ar | Encounter the creature to unlock the entry. | قابل المخلوق لفتح بطاقته.
[H] tip2 | ar | Reloading takes 1.5 seconds. | إعادة التلقيم تستغرق 1.5 ثانية.
[H] confirm_quit | ar | Quit for sure? | هل تريد الخروج؟
[H] ACH_07_NAME | ar | Combo Master | سيد الكومبو
[H] ENEMY_SLASHER | ar | Slasher | الممزّق
[H] ENEMY_SPITTER | ar | Spitter | الباصق
[H] ITEM_FUSE | ar | Fuse | فيوز
[H] SCR_PREDOHRANITEL | ar | fuse | فيوز
[H] DISTRICT_RESTORED_TOAST | ar | District saved: %s | تمت استعادة المنطقة: %s
[H] VICTORY_DISTRICTS | ar | Districts restored | المناطق المستعادة
[H] ENDING_LIGHT_DESC | ar | All 11 districts restored, every document found. The reactor is running and the city lights up. The radio says: “Thank you.” | استُعيدت كل الأحياء الـ11، وعُثر على كل الوثائق. المفاعل يعمل والمدينة تضيء. يقول الراديو: "شكرًا لك".
[H] END_LIGHT_DESC | ar | The reactor runs, the city is restored. The radio says: “Thank you.” | المفاعل يعمل، والمدينة استُعيدت. يقول الراديو: "شكرًا لك".
[H] Hardcore Mode | ar | Hardcore Mode | وضع Hardcore
[H] craft | ar | Craft | صنع
[H] WORKBENCH_CREATE_BTN | ar | Create | صنع
[H] WEAKSPOT_BLUNT | ar | Blunt damage | ضرر الصدم
[H] Q_FIND_ENGINEERS_DESC | ar | Track the engineering crew through the residential sector | تتبّع فريق المهندسين عبر الحي السكني
[H] WORLD_FACTION_WATCH_TEXT | ar | Do not knock. We don't open doors after sunset anymore. Take the canned food from the step. | لا تطرقوا الباب. لم نعد نفتح الأبواب بعد الغروب. خذوا الطعام المعلّب من على العتبة.
[H] WORLD_CHAR_RADIOVOICE_TEXT | ar | Go to the power station. The one who kept the light will meet you at the light. | اذهب إلى محطة الطاقة. من حفظ الضوء سيقابلك عند الضوء.
[H] WORLD_RADIO_03_TEXT | ar | You are restoring what I am taking apart, and we are both right. Every lamp you light feeds the city. Every lamp I carry out starves the thing in the center. Light the districts. I will meet you at the last one with everything I have kept. Forty years of light, engineer. Bring a strong back. | أنت تستعيد ما أفككه، وكلانا محق. كل مصباح تضيئه يغذي المدينة. كل مصباح أحمله بعيدًا يجوّع ذلك الشيء في المركز. أضئ الأحياء. سأقابلك في الأخير بكل ما حفظته. أربعون عامًا من الضوء أيها المهندس. ستحتاج ظهرًا قويًا.
[H] WORLD_NEWS_ARCHITECT_TEXT | ar | The council denies funding any 'Project Architect' to 'store what the lamps have seen'. The denial names the project by title, which no reporter had used. The program's test feeders, records show, were wired through the hospital sub-feed and the park line. | ينفي المجلس تمويل أي «مشروع المهندس المعماري» لـ«تخزين ما رأته المصابيح». ينفي البيان بذكر اسم المشروع، وهو عنوان لم يستخدمه أي صحفي من قبل. تُظهر السجلات أن مغذيات اختبار البرنامج كانت موصولة عبر خط التغذية الفرعي للمستشفى وخط الحديقة.
[H] WORLD_NEWS_ARCHITECT_TITLE | ar | Council Denies 'Grid Memory' Program | المجلس ينفي برنامج «ذاكرة الشبكة»
[H] WORLD_NEWS_TREES_TEXT | ar | The central park closes until further notice following repeated complaints that the trees 'lean toward the lamps to listen'. The parks office: trees do not listen. Night gardeners, unnamed, add that the leaning started the week the new feeder hummed. | تُغلق الحديقة المركزية حتى إشعار آخر بعد شكاوى متكررة بأن الأشجار «تميل نحو المصابيح لتستمع». مكتب الحدائق: الأشجار لا تستمع. يضيف بستانيون ليليون، مجهولو الاسم، أن الميل بدأ في الأسبوع الذي بدأت فيه التغذية الجديدة بالطنين.
[H] WORLD_DIARY_M1_TEXT | ar | Three of them came to the pond again. The tall one that was the postman stands apart; he is ashamed. I put the bowl on the ice and I said their names out loud, all of them. They stood still when I said them. They remember. The light remembers too — that is why I keep my lamp. | جاء ثلاثة منهم إلى البركة مجددًا. الطويل الذي كان ساعي البريد يقف بمعزل؛ إنه يشعر بالخجل. وضعت الوعاء على الجليد وقلت أسماءهم بصوت عالٍ، كلهم. وقفوا ساكنين عندما قلتها. إنهم يتذكرون. والضوء يتذكر أيضًا — لهذا أُبقي مصباحي مضاءً.
