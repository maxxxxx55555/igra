...
## Session 12 (2026-09-25): C8 verifier loop, rounds 1-8 closed -> rc9

**NEXT-ROW: C8 round 9 (independent verifier on `v8.0.0-rc9`)**, loop until FAKE=0 PARTIAL=0; then C9 AAB
