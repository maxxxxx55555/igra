...
## Session 12 (2026-09-25): C8 verifier loop, rounds 1-4 closed -> rc5

**NEXT-ROW: C8 round 5 (independent verifier on `v8.0.0-rc5`)**, loop until FAKE=0 PARTIAL=0; then C9 AAB
